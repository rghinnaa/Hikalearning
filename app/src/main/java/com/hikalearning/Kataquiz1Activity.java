...
public class Kataquiz1Activity extends Activity implements OnClickListener {
	...
	int skor=0;
	int ben,sal;
	private QuestionQuiz4 questbank = new QuestionQuiz4();
	...
	MediaPlayer audioClick;
	 @Override
	    protected void onCreate(Bundle savedInstanceState) {
         ...
         setContentView(R.layout.activity_hiraquiz1);
